#!/usr/bin/env python3
"""
Extract ALL procedures with comprehensive metadata for patient C1277724
...
class AllProceduresExtractor:
    def __init__(self, aws_profile: str, database: str):
        ...
        self.patient_fhir_id = "eXdoUrDdY4gkdnZEs6uTeq-MEZEFJsVmSduLKRoTdXmE3"
    ...
    def merge_and_export(self, procedures_df: pd.DataFrame, codes_df: pd.DataFrame,
        ...
        # Export to CSV
        output_dir = Path('athena_extraction_validation/reports')
        output_dir.mkdir(parents=True, exist_ok=True)
        output_file = output_dir / f'ALL_PROCEDURES_METADATA_{self.patient_research_id}.csv'
...
def main():
    ...
    try:
        ...
        if not procedures_df.empty:
            ...
            print(f"\n  Output: athena_extraction_validation/reports/ALL_PROCEDURES_METADATA_C1277724.csv")
            print(f"\n{'='*80}\n")
        else:
            print("\n❌ No procedures found\n")
