...
# Output file
OUTPUT_FILE = STAGING_DIR / f'ALL_MEASUREMENTS_METADATA_{PATIENT_MRN}.csv'
...
class MeasurementsExtractor:
    ...
    def merge_all_data(self, observations_df, lab_tests_df, lab_results_df):
        ...
        try:
            birth_dt = pd.to_datetime(BIRTH_DATE).tz_localize(None)
...
def main():
    ...
    extractor = MeasurementsExtractor()
