#!/usr/bin/env python3
"""
Deploy updated v_concomitant_medications view to Athena from DATETIME_STANDARDIZED_VIEWS.sql.

Updates:
- Uses v_chemo_medications instead of RxNorm matching (2,968 drugs vs 814)
...
def deploy_view(athena):
    ...
    view_sql = extract_view_sql('/Users/resnick/Documents/GitHub/RADIANT_PCA/BRIM_Analytics/athena_views/views/DATETIME_STANDARDIZED_VIEWS.sql')

    print("=" * 100)
    print("DEPLOYING v_concomitant_medications VIEW FROM MASTER FILE")
    print("=" * 100)
    print("\nView updates:")
    ...
    print("- ❌ OLD: RxNorm matching approach (814 drugs)")
...
def main():
    ...
    print("2. Compare with v_chemo_medications to ensure consistency (should match 968 patients)")
