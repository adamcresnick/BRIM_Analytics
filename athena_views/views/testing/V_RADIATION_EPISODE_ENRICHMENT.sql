-- ============================================================================
-- VIEW: v_radiation_episode_enrichment
-- ============================================================================
-- Purpose: Enrich radiation episodes with appointment and care plan metadata
-- Base: v_radiation_treatment_episodes (499 patients, 967 episodes)
-- Enrichment Sources:
--   - Strategy C: Appointment metadata (temporal phase classification)
--   - Strategy B: Care plan protocols and intents
-- ============================================================================
...
care_plan_aggregations AS (
    ...
    SELECT
        ...
        MIN(CAST(cp_period_start AS DATE)) as earliest_care_plan_start,
        MAX(CAST(cp_period_end AS DATE)) as latest_care_plan_end
