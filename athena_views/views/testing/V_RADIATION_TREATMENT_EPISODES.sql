-- ============================================================================
-- VIEW: v_radiation_treatment_episodes
-- ============================================================================
-- Purpose: Unified radiation episode base combining all detection strategies
-- Coverage: ~499 patients (72% of radiation patients)
-- Testing Stage: Combined view of validated strategies
-- ============================================================================
-- Strategy A: 93 patients with structured observations (course_id)
-- Strategy D: 406 patients with document temporal clustering (30-day gap)
-- ============================================================================
